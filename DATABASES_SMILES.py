...
def get_smiles_from_name_from_pubchem(name, ligands_ids_by_names, ligands_resources_by_names):
...
def get_common_pdbs_from_ligand_name_and_target_uniprot(name_lig, uniprot, sim,
    ...
    INPUT -- ligand's name name_lig (SMILES searched by sim, see function get_smiles_from_name_from_pubchem)
    uniprot of target
    ...
    smiles_of_ligand = get_smiles_from_name_from_pubchem(name_lig, ligands_ids_by_names, ligands_resources_by_names)
...
def get_common_pdbs_with_all_targets_of_ligand(name_lig, sim,
    ...
    INPUT -- ligand's name is name_lig (SMILES searched by sim, see function get_smiles_from_name_from_pubchem)
